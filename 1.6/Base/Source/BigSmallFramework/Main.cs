...
namespace BigAndSmall
{
    ...
    public class GlobalSettings : Def
    {
        ...
        // Will be used by the the RenderNodePatcher to add shaders to the shader dropdown for auto-generated nodes.
        public List<ShaderTypeDef> autoGeneratedShaderOptions = [];
        ...
        public static List<ShaderTypeDef> AllAutoGeneratedShaderOptions => [.. globalSettings.Values
            .SelectMany(x => x.autoGeneratedShaderOptions ?? []).Distinct()];
