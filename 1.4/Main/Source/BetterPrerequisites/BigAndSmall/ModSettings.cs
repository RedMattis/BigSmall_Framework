...
namespace BigAndSmall
{
    ...
    public class BigSmallMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listStd.CheckboxLabeled("BS_DisabeVFCachine".Translate(), ref settings.disableVFETextureCaching, 1);
    ...
    public class BSRettings : ModSettings
    {
        ...
        private static readonly bool defaultDisableVFETextureCaching = true;
        public bool disableVFETextureCaching = defaultDisableVFETextureCaching;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref disableVFETextureCaching, "disableVFETextureCaching", defaultDisableVFETextureCaching);
