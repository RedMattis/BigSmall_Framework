...
namespace BigAndSmall
{
    ...
    {
        public string scoreCalculatorType = nameof(ScoreCalculator);
        private ScoreCalculator _calculator = null;

        public abstract IEnumerable<IScoreProvider> Selectors { get; }
        public virtual ScoreCalculator Calculator => _calculator ??= (ScoreCalculator)Activator.CreateInstance(Type.GetType(scoreCalculatorType), this);
